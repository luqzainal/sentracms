              ...
              {clientEvents.length > 0 ? (
                <div className="space-y-4">
                  {clientEvents.map((event) => (
                    <div key={event.id} className="bg-slate-50 rounded-lg p-4 border border-slate-200 hover:bg-slate-100 transition-colors">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-600">Contact support to schedule an appointment</p>
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-sm font-medium text-blue-900">Live Chat</p>
                        <p className="text-xs text-blue-700">Chat with our support team</p>
                      </div>
                    </div>
                  </div>
                </div>
