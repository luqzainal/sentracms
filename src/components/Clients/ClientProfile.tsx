...
const ClientProfile: React.FC<ClientProfileProps> = ({ clientId, onBack, onEdit }) => {
  ...
  const handleSaveComponent = (componentData: any) => {
    const invoiceId = showComponentModal;
            ...
            {invoices.length > 0 ? (
              <div className="space-y-4">
                {invoices.map((invoice) => {
                  const invoiceComponents = getComponentsByInvoiceId(invoice.id);
                  ...
                  return (
                    <div key={invoice.id} className="space-y-2">
                      ...
                      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h4 className="font-semibold text-blue-900">{invoice.packageName}</h4>
                      ...
                      {/* Child Components for this invoice */}
                      {invoiceComponents.length > 0 && (
              ...
              <div className="text-center py-8 text-slate-500">
                ...
                <p className="text-sm">Create an invoice to set up a package</p>
              </div>
            )}
          </div>
        </div>
